...
certoraRun :; certoraRun --solc ~/.solc-select/artifacts/solc-0.6.12 src/DssDirectDepositAaveDai.sol certora/Vat.sol --link DssDirectDepositAaveDai:vat=Vat --verify DssDirectDepositAaveDai:certora/DssDirectDepositAaveDai.spec --rule_sanity
